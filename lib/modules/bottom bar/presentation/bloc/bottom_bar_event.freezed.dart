...
class __$$IndexChangedImplCopyWithImpl<$Res>
    extends _$BottomBarEventCopyWithImpl<$Res, _$IndexChangedImpl>
...
class _$IndexChangedImpl implements IndexChanged {
  ...
  @override
  String toString() {
    return 'BottomBarEvent.indexChanged(index: $index)';
  }
...
abstract class IndexChanged implements BottomBarEvent {
  const factory IndexChanged(final int index) = _$IndexChangedImpl;
