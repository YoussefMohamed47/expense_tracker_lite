...
abstract class $ExpenseModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      DateTime date,
      String icon,
      @ColorStringConverter() Color backgroundColor,
      @ColorStringConverter() Color iconColor});
}
...
class _$ExpenseModelImpl implements _ExpenseModel {
  const _$ExpenseModelImpl(
      ...
      required this.date,
      required this.icon,
      @ColorStringConverter() required this.backgroundColor,
      @ColorStringConverter() required this.iconColor});
  ...
  @override
  String toString() {
    return 'ExpenseModel(id: $id, category: $category, source: $source, amount: $amount, receipt: $receipt, convertedAmount: $convertedAmount, currency: $currency, date: $date, icon: $icon, backgroundColor: $backgroundColor, iconColor: $iconColor)';
  }
...
abstract class _ExpenseModel implements ExpenseModel {
  const factory _ExpenseModel(
          ...
          @ColorStringConverter() required final Color backgroundColor,
          @ColorStringConverter() required final Color iconColor}) =
      _$ExpenseModelImpl;
